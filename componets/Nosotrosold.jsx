    ...
    <>
      <div className={`${fuentePoppins.className} ${styles.contenedorAbout}`}>
        ...
        <div className={styles.textoAbout}>
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam, vel consectetur. Explicabo pariatur totam ipsum. Cupiditate unde aliquam eum doloremque asperiores excepturi maiores est eaque, blanditiis dolores possimus corporis fuga!</p>
